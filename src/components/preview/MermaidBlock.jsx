// src/components/preview/MermaidBlock.jsx v3.1
/*
 * 파일 위치: src/components/preview/MermaidBlock.jsx
 * 기능 요약: Mermaid 문법을 파싱하여 SVG 다이어그램으로 렌더링하는 컴포넌트입니다. (배포를 위해 콘솔 로그 출력 기능이 제거되었습니다.)
