// src/components/preview/StlBlock.jsx v6.1
/*
 * 파일 위치: src/components/preview/StlBlock.jsx
 * 기능 요약: Three.js의 STLLoader가 ArrayBuffer를 이진 데이터(Binary)로 오인하여 발생하는 RangeError(메모리 초과 할당)를 해결하기 위해, 순수 문자열(String)을 직접 파싱하도록 수정된 렌더러 컴포넌트입니다. (배포를 위해 콘솔 로그 출력 기능이 제거되었습니다.)
