...
function CodeBlockRenderer({ inline, className, children, ...props }) {
  ...
  // Preview.jsx에서 최상단 <pre> 태그에 직접 래퍼를 씌워주므로 여기서는 순수한 <code>와 복사 버튼만 렌더링합니다.
  if (!inline) {
    ...
    return (
      <>
        {copyButton}
        {isDiff ? (
          <code className="language-diff" style={{ display: 'block', overflowX: 'auto', fontFamily: 'ui-monospace, SFMono-Regular, "SF Mono", Menlo, Consolas, "Liberation Mono", monospace', fontSize: '14px', lineHeight: '1.45' }}>
          ...
          <code 
            ...
            style={{ display: 'block', overflowX: 'auto', fontFamily: 'ui-monospace, SFMono-Regular, "SF Mono", Menlo, Consolas, "Liberation Mono", monospace', fontSize: '14px', lineHeight: '1.45' }}
