// src/components/diagram/forms/GeoJsonForm.jsx v1.1
/*
 * 파일 위치: src/components/diagram/forms/GeoJsonForm.jsx
 * 기능 설명: 대화형 지도(GeoJSON) 전용 GUI 입력 폼 컴포넌트입니다. (배포를 위해 콘솔 로그 출력 기능이 제거되었습니다.)
